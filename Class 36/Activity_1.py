...
SCREEN_HEIGHT, SCREEN_WIDTH = 900, 900
MOVEMENT_SPEED = 10
FONT_SIZE = 72

pygame.init()

bg_image = pygame.transform.scale(pygame.image.load("bg_img.jpg"), (SCREEN_WIDTH, SCREEN_HEIGHT))
...
class Sprite(pygame.sprite.Sprite):
    ...
    def moving_sprite(self, x_change, y_change):
...
while running:
    ...
    if not won:
        ...
        sprite1.moving_sprite(x_change, y_change)
